...
class Iface(object):
    ...
    def registerPrimaryUsingSocialLogin(self, authSessionId):
        """
        Parameters:
         - authSessionId
    ...
    def migratePrimaryUsingSocialLogin(self, authSessionId):
        """
        Parameters:
         - authSessionId
    ...
    def verifySocialLogin(self, authSessionId, device, socialLogin):
        """
        Parameters:
         - authSessionId
         - device
    ...
    def getCountryInfo(self, authSessionId, simCard):
        """
        Parameters:
         - authSessionId
         - simCard
...
class Client(Iface):
    ...
    def registerPrimaryUsingSocialLogin(self, authSessionId):
        ...
        """
        self.send_registerPrimaryUsingSocialLogin(authSessionId)
        return self.recv_registerPrimaryUsingSocialLogin()

    def send_registerPrimaryUsingSocialLogin(self, authSessionId):
        self._oprot.writeMessageBegin('registerPrimaryUsingSocialLogin', TMessageType.CALL, self._seqid)
        args = registerPrimaryUsingSocialLogin_args()
        args.authSessionId = authSessionId
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_registerPrimaryUsingSocialLogin(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = registerPrimaryUsingSocialLogin_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "registerPrimaryUsingSocialLogin failed: unknown result")
    ...
    def migratePrimaryUsingSocialLogin(self, authSessionId):
        ...
        """
        self.send_migratePrimaryUsingSocialLogin(authSessionId)
        return self.recv_migratePrimaryUsingSocialLogin()

    def send_migratePrimaryUsingSocialLogin(self, authSessionId):
        self._oprot.writeMessageBegin('migratePrimaryUsingSocialLogin', TMessageType.CALL, self._seqid)
        args = migratePrimaryUsingSocialLogin_args()
        args.authSessionId = authSessionId
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_migratePrimaryUsingSocialLogin(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = migratePrimaryUsingSocialLogin_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "migratePrimaryUsingSocialLogin failed: unknown result")
    ...
    def verifySocialLogin(self, authSessionId, device, socialLogin):
        ...
        """
        self.send_verifySocialLogin(authSessionId, device, socialLogin)
        return self.recv_verifySocialLogin()

    def send_verifySocialLogin(self, authSessionId, device, socialLogin):
        self._oprot.writeMessageBegin('verifySocialLogin', TMessageType.CALL, self._seqid)
        args = verifySocialLogin_args()
        args.authSessionId = authSessionId
        args.device = device
        args.socialLogin = socialLogin
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_verifySocialLogin(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = verifySocialLogin_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "verifySocialLogin failed: unknown result")
    ...
    def getCountryInfo(self, authSessionId, simCard):
        ...
        """
        self.send_getCountryInfo(authSessionId, simCard)
        return self.recv_getCountryInfo()

    def send_getCountryInfo(self, authSessionId, simCard):
        self._oprot.writeMessageBegin('getCountryInfo', TMessageType.CALL, self._seqid)
        args = getCountryInfo_args()
        args.authSessionId = authSessionId
        args.simCard = simCard
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getCountryInfo(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getCountryInfo failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["registerPrimaryUsingSocialLogin"] = Processor.process_registerPrimaryUsingSocialLogin
        self._processMap["migratePrimaryUsingSocialLogin"] = Processor.process_migratePrimaryUsingSocialLogin
        ...
        self._processMap["verifySocialLogin"] = Processor.process_verifySocialLogin
        ...
        self._processMap["getCountryInfo"] = Processor.process_getCountryInfo
    ...
    def process_registerPrimaryUsingSocialLogin(self, seqid, iprot, oprot):
        args = registerPrimaryUsingSocialLogin_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = registerPrimaryUsingSocialLogin_result()
        try:
            result.success = self._handler.registerPrimaryUsingSocialLogin(args.authSessionId)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except AuthException as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("registerPrimaryUsingSocialLogin", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_migratePrimaryUsingSocialLogin(self, seqid, iprot, oprot):
        args = migratePrimaryUsingSocialLogin_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = migratePrimaryUsingSocialLogin_result()
        try:
            result.success = self._handler.migratePrimaryUsingSocialLogin(args.authSessionId)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except AuthException as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("migratePrimaryUsingSocialLogin", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_verifySocialLogin(self, seqid, iprot, oprot):
        args = verifySocialLogin_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = verifySocialLogin_result()
        try:
            result.success = self._handler.verifySocialLogin(args.authSessionId, args.device, args.socialLogin)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except AuthException as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("verifySocialLogin", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_setPassword(self, seqid, iprot, oprot):
        ...
        result = setPassword_result()
        try:
            self._handler.setPassword(args.authSessionId, args.encryptedPassword)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except AuthException as e:
    ...
    def process_getCountryInfo(self, seqid, iprot, oprot):
        args = getCountryInfo_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getCountryInfo_result()
        try:
            result.success = self._handler.getCountryInfo(args.authSessionId, args.simCard)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except AuthException as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getCountryInfo", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_validateProfile(self, seqid, iprot, oprot):
        ...
        result = validateProfile_result()
        try:
            self._handler.validateProfile(args.authSessionId, args.displayName)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except AuthException as e:
...
class registerPrimaryUsingSocialLogin_args(object):
    """
    Attributes:
     - authSessionId
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('registerPrimaryUsingSocialLogin_args')
        if self.authSessionId is not None:
            oprot.writeFieldBegin('authSessionId', TType.STRING, 2)
            oprot.writeString(self.authSessionId.encode('utf-8') if sys.version_info[0] == 2 else self.authSessionId)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(registerPrimaryUsingSocialLogin_args)
registerPrimaryUsingSocialLogin_args.thrift_spec = (
    None,  # 0
    None,  # 1
    (2, TType.STRING, 'authSessionId', 'UTF8', None, ),  # 2
)
...
class registerPrimaryUsingSocialLogin_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('registerPrimaryUsingSocialLogin_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(registerPrimaryUsingSocialLogin_result)
registerPrimaryUsingSocialLogin_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [RegisterPrimaryResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [AuthException, None], None, ),  # 1
)


class migratePrimaryUsingSocialLogin_args(object):
    """
    Attributes:
     - authSessionId
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('migratePrimaryUsingSocialLogin_args')
        if self.authSessionId is not None:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(migratePrimaryUsingSocialLogin_args)
migratePrimaryUsingSocialLogin_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'authSessionId', 'UTF8', None, ),  # 1
)


class migratePrimaryUsingSocialLogin_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('migratePrimaryUsingSocialLogin_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(migratePrimaryUsingSocialLogin_result)
migratePrimaryUsingSocialLogin_result.thrift_spec = (
...
class verifySocialLogin_args(object):
    """
    Attributes:
     - authSessionId
     - device
    ...
    def __init__(self, authSessionId=None, device=None, socialLogin=None,):
        self.authSessionId = authSessionId
        self.device = device
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('verifySocialLogin_args')
        if self.authSessionId is not None:
            oprot.writeFieldBegin('authSessionId', TType.STRING, 1)
            oprot.writeString(self.authSessionId.encode('utf-8') if sys.version_info[0] == 2 else self.authSessionId)
            oprot.writeFieldEnd()
        ...
        if self.socialLogin is not None:
            oprot.writeFieldBegin('socialLogin', TType.STRUCT, 3)
            self.socialLogin.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(verifySocialLogin_args)
verifySocialLogin_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'authSessionId', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'device', [Device, None], None, ),  # 2
    (3, TType.STRUCT, 'socialLogin', [SocialLogin, None], None, ),  # 3
)


class verifySocialLogin_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = VerifySocialLoginResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('verifySocialLogin_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(verifySocialLogin_result)
verifySocialLogin_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [VerifySocialLoginResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [AuthException, None], None, ),  # 1
)
...
class getCountryInfo_args(object):
    """
    Attributes:
     - authSessionId
     - simCard
    ...
    def __init__(self, authSessionId=None, simCard=None,):
        self.authSessionId = authSessionId
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getCountryInfo_args')
        if self.authSessionId is not None:
            oprot.writeFieldBegin('authSessionId', TType.STRING, 1)
            oprot.writeString(self.authSessionId.encode('utf-8') if sys.version_info[0] == 2 else self.authSessionId)
            oprot.writeFieldEnd()
        if self.simCard is not None:
            oprot.writeFieldBegin('simCard', TType.STRUCT, 2)
            self.simCard.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getCountryInfo_args)
getCountryInfo_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'authSessionId', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'simCard', [SimCard, None], None, ),  # 2
)


class getCountryInfo_result(object):
    """
    Attributes:
     - success
     - e
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = GetCountryInfoResponse()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getCountryInfo_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getCountryInfo_result)
getCountryInfo_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [GetCountryInfoResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [AuthException, None], None, ),  # 1
)
