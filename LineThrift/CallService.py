...
class Client(Iface):
    ...
    def acquireTestCallRoute(self):
        self.send_acquireTestCallRoute()
        return self.recv_acquireTestCallRoute()

    def send_acquireTestCallRoute(self):
        self._oprot.writeMessageBegin('acquireTestCallRoute', TMessageType.CALL, self._seqid)
        args = acquireTestCallRoute_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_acquireTestCallRoute(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "acquireTestCallRoute failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["acquireTestCallRoute"] = Processor.process_acquireTestCallRoute
    ...
    def process_acquireTestCallRoute(self, seqid, iprot, oprot):
        args = acquireTestCallRoute_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = acquireTestCallRoute_result()
        try:
            result.success = self._handler.acquireTestCallRoute()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TalkException as e:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("acquireTestCallRoute", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class acquireTestCallRoute_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(acquireTestCallRoute_args)
acquireTestCallRoute_args.thrift_spec = (
)
...
class acquireTestCallRoute_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(acquireTestCallRoute_result)
acquireTestCallRoute_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TestCallRoute, None], None, ),  # 0
    (1, TType.STRUCT, 'e', [TalkException, None], None, ),  # 1
)
...
class acquireCallRoute_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i538 in range(_size534):
                        ...
                        _val540 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.fromEnvINfo[_key539] = _val540
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.callType is not None:
            oprot.writeFieldBegin('callType', TType.I32, 2)
            oprot.writeI32(self.callType)
            oprot.writeFieldEnd()
        if self.fromEnvINfo is not None:
            oprot.writeFieldBegin('fromEnvINfo', TType.MAP, 3)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.fromEnvINfo))
            for kiter541, viter542 in self.fromEnvINfo.items():
...
acquireCallRoute_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'to', 'UTF8', None, ),  # 1
    (2, TType.I32, 'callType', None, None, ),  # 2
    (3, TType.MAP, 'fromEnvINfo', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 3
)
...
class acquireGroupCallRoute_args(object):
            ...
            if fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i547 in range(_size543):
                        ...
                        self.capabilities.append(_elem548)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.capabilities is not None:
            ...
            for iter549 in self.capabilities:
